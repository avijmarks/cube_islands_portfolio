...
public class Tutorial : MonoBehaviour {
	...
	void Start () 
    {
        tutorialNodeLabel = GameText.generator.CreateTextNode("TUTORIAL", "Button", gameObject.transform, new Vector3(0f, 2f, 0f), Vector3.zero, gameObject.transform, MoreText);	
	}
